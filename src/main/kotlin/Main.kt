...
fun main() {
    ...
    run {
        ...
        println("Text origin:\n$text")
        println("Text with align left(30):\n${changeAlignText(text, 20, Alignment.LEFT)}")
        println("Text with align center(35):\n${changeAlignText(text, 25, Alignment.CENTER)}")
        println("Text with align right(40):\n${changeAlignText(text, 40, Alignment.RIGHT)}")
